...
const STYLES = `
  ...
  .tabs { display:flex; gap:4px; margin-bottom:20px; background:var(--sr-surface); border:1px solid var(--sr-border-solid); border-radius:10px; padding:4px; width:fit-content; }
  .tab { padding:7px 18px; border-radius:7px; font-size:0.83rem; font-weight:600; cursor:pointer; color:var(--sr-muted); border:none; background:transparent; transition:all 0.15s; }
  .tab.active { background:var(--sr-border-solid); color:var(--sr-text); }
  .toolbar { display:flex; gap:10px; margin-bottom:20px; align-items:center; }
  .export-btn { margin-left:auto; background:var(--sr-border-solid); border:1px solid #3A3028; border-radius:8px; padding:8px 16px; color:var(--sr-text); font-size:0.82rem; font-weight:600; cursor:pointer; }
  .export-btn:hover { border-color:var(--sr-orange); }
  .table-wrap { background:var(--sr-surface); border:1px solid var(--sr-border-solid); border-radius:12px; overflow:hidden; }
  .table-row { display:grid; grid-template-columns:1.5fr 1fr 1fr 2fr 1fr 160px; gap:12px; padding:13px 20px; border-bottom:1px solid var(--sr-border-solid); align-items:center; }
  ...
  .cell-main { font-size:0.83rem; font-weight:600; color:var(--sr-text); white-space:nowrap; overflow:hidden; text-overflow:ellipsis; }
  .cell-sub { font-size:0.73rem; color:var(--sr-muted); margin-top:2px; }
  .amount-text { font-size:0.9rem; font-weight:700; color:var(--sr-text); }
  ...
  .limit-tip { font-size:0.7rem; color:var(--sr-muted); margin-top:3px; }
  .empty-row { padding:48px; text-align:center; color:var(--sr-sub); font-size:0.84rem; }
  /* Modal */
  ...
  .modal h2 { font-size:1rem; font-weight:700; color:var(--sr-text); margin-bottom:8px; }
  .modal p { font-size:0.84rem; color:var(--sr-muted); margin-bottom:16px; }
  .modal textarea { width:100%; background:var(--sr-bg); border:1px solid var(--sr-border-solid); border-radius:8px; padding:10px 12px; color:var(--sr-text); font-size:0.85rem; resize:vertical; min-height:80px; outline:none; font-family:inherit; }
  ...
  .btn-cancel { background:var(--sr-border-solid); color:var(--sr-muted); border:1px solid #3A3028; border-radius:8px; padding:8px 18px; font-size:0.84rem; font-weight:600; cursor:pointer; }
  .btn-confirm { background:var(--sr-orange); color:#fff; border:none; border-radius:8px; padding:8px 18px; font-size:0.84rem; font-weight:600; cursor:pointer; }
          ...
          {filtered.length === 0 ? (
            ...
            return (
              <div key={r.id} className="table-row">
                ...
                <div className="amount-text" style={{color:'var(--sr-muted)', fontWeight:500}}>
