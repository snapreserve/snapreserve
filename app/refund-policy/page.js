    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .policy-card { background: white; border: 1px solid #E8E2D9; border-radius: 16px; padding: 20px; }
        ...
        .policy-title { font-size: 1rem; font-weight: 700; color: #1A1410; margin-bottom: 10px; }
        .policy-rule { font-size: 0.8rem; color: #4A3F35; line-height: 1.6; margin-bottom: 6px; }
