    ...
    <>
      <style>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-link { padding: 8px 16px; border-radius: 100px; font-size: 0.84rem; font-weight: 600; text-decoration: none; color: #6B5F54; transition: all 0.15s; }
        .nav-link:hover { background: #F3F0EB; color: #1A1410; }
        .nav-link.active { background: #F3F0EB; color: #F4601A; font-weight: 700; }
        ...
        .page-sub { font-size: 0.88rem; color: #6B5F54; }

        .tabs { display: flex; gap: 4px; background: #F3F0EB; border-radius: 12px; padding: 4px; margin-bottom: 28px; width: fit-content; }
        .tab-btn { padding: 8px 20px; border-radius: 9px; border: none; background: transparent; font-size: 0.85rem; font-weight: 600; color: #6B5F54; cursor: pointer; font-family: inherit; transition: all 0.15s; display: flex; align-items: center; gap: 6px; }
        .tab-btn.active { background: white; color: #1A1410; box-shadow: 0 1px 4px rgba(0,0,0,0.08); }
        .tab-count { font-size: 0.72rem; background: #E8E2D9; color: #6B5F54; padding: 1px 7px; border-radius: 100px; font-weight: 700; }
        .tab-btn.active .tab-count { background: #F4601A; color: white; }

        .bookings-list { display: flex; flex-direction: column; gap: 16px; }

        .booking-card { background: white; border: 1px solid #E8E2D9; border-radius: 16px; overflow: hidden; display: flex; transition: box-shadow 0.2s; }
        .booking-card:hover { box-shadow: 0 4px 20px rgba(0,0,0,0.08); }
        .booking-img { width: 140px; flex-shrink: 0; object-fit: cover; background: #E8E2D9; }
        ...
        .booking-location { font-size: 0.78rem; color: #6B5F54; }
        ...
        .date-item { }
        .date-label { font-size: 0.6rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.1em; color: #A89880; margin-bottom: 2px; }
        .date-value { font-size: 0.84rem; font-weight: 600; }
        .booking-footer { display: flex; align-items: center; justify-content: space-between; }
        .booking-ref { font-size: 0.72rem; color: #A89880; font-family: monospace; }
        .booking-total { font-weight: 700; font-size: 0.96rem; }
        .booking-nights { font-size: 0.72rem; color: #6B5F54; font-weight: 400; margin-left: 4px; }

        .empty-state { text-align: center; padding: 60px 20px; }
        .empty-icon { font-size: 3rem; margin-bottom: 16px; }
        .empty-title { font-size: 1.1rem; font-weight: 700; margin-bottom: 8px; }
        .empty-sub { font-size: 0.88rem; color: #6B5F54; margin-bottom: 24px; }
        ...
        .spinner { width: 36px; height: 36px; border: 3px solid #E8E2D9; border-top-color: #F4601A; border-radius: 50%; animation: spin 0.8s linear infinite; margin: 60px auto; }
